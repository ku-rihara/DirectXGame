...
void StressGaugeGauge::SpriteInit() {
...
void StressGaugeGauge::Update(float deltaTime) {
    // UVスクロール更新
...
void StressGaugeGauge::UpdateGaugeUV(float deltaTime) {
    // UVを右から左にスクロール
...
void StressGaugeGauge::UpdateGaugeColor() {
    if (!gaugeSprite_) {
        return;
    }
...
void StressGaugeGauge::SetTimer(float currentTimer, float maxTimer) {
    if (maxTimer > 0.0f) {
...
/// パラメータ調整
///==========================================================
void StressGaugeGauge::AdjustParam() {
...
void StressGaugeGauge::RegisterParams() {
...
void StressGaugeGauge::PlayTimerRecoveryScaling() {
    if (frameSprite_) {
...
void StressGaugeGauge::UpdatePercentDigits() {
...
void StressGaugeGauge::SetSpriteScales(const Vector2& scale) {
