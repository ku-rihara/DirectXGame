#include "LeaderEnemyFleeBehavior.h"
...
LeaderEnemyFleeBehavior::LeaderEnemyFleeBehavior(LeaderEnemy* enemy, float startDelay)
    : LeaderEnemyBehaviorBase("LeaderEnemyFleeBehavior", enemy), startDelayTimer_(startDelay) {
...
void LeaderEnemyFleeBehavior::Update() {
...
void LeaderEnemyFleeBehavior::Debug() {}