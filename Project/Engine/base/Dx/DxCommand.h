...
private:
    ...
    /// </summary>
    /// <param name="device">D3D12デバイス</param>
    void CreateCommandQueue(const Microsoft::WRL::ComPtr<ID3D12Device>& device);

    /// <summary>
    /// コマンドアロケータ作成
    /// </summary>
    /// <param name="device">D3D12デバイス</param>
    void CreateCommandAllocator(const Microsoft::WRL::ComPtr<ID3D12Device>& device);
    ...
    /// </summary>
    /// <param name="device">D3D12デバイス</param>
    void CreateFence(const Microsoft::WRL::ComPtr<ID3D12Device>& device);
